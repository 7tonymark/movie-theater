...
function Slider (){
    ...
    return (
        <div className="slider"> {
            ...
            <button id="goLeftUpcoming"  onClick={goLeftUpcoming}><i id="left-button" class="fas fa-chevron-left"></i></button>
            <button id="goRightUpcoming" onClick={goRightUpcoming}><i id="left-button" class="fas fa-chevron-right"></i></button>
        </div>
    )
};
