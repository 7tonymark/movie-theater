...
function Slider (){
    ...
    return (
        <div className="slider"> {
            ...
            <button id="goLeft"  onClick={goLeft}><i id="left-button" class="fas fa-chevron-left"></i></button>
            <button id="goRight" onClick={goRight}><i id="left-button" class="fas fa-chevron-right"></i></button>
        </div>
    )
};
